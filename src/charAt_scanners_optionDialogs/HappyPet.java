...
public class HappyPet {
	...
	public static void main(String[] args) {
		...
		// a variable
		String pet = JOptionPane.showInputDialog("What kind of pet would you like? (cat or dog)");
	...
	public static void bark() {
		JOptionPane.showMessageDialog(null, "bark bark woof");
		happinessLevel++;
	}

	public static void tailWag() {
		JOptionPane.showMessageDialog(null, "*wags tail*");
		happinessLevel++;
	}
	...
	public static void poopCleaned() {
	...
	public static void lazy() {
		JOptionPane.showMessageDialog(null, "I'm not going on a walk! I'm too lazy for that...");
		happinessLevel--;
	}
}